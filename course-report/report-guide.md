...
- **S2：** 完成推文后务必贴入 [md.doocs.org](https://md.doocs.org/) 或 [mdnice.com](https://mdnice.com/) 测试一下文中的数学公式和图片是否能正常显示
...
将 .md 输出为 HTML 和 PDF 的快捷方法：

> 网址：<https://md.doocs.org/>

- **样式**：右上角按钮，选择喜欢的配色和风格。建议：
  - 字体：衬线
  - 字号：稍小 (14px)
  - 主题色：经典蓝 / 橄榄绿 / 石墨黑
  - Mac 代码块：开启
  ...
  - 段落首行缩进：关闭
  - 段落两端对齐：关闭
- **导出**：文件 --> 导出 --> 选 PDF 或 HTML
  - Note：导出前请先修改文件名，它将显示为 PDF 文档的页眉。
